...
var Zepto = (function() {
  var undefined,
    ...
    $,
    classList,
    emptyArray = [],  // 数组字面量写法，[] 相当于 构造函数 new Array()，实例化一个对象
    // 由于 [].__proto__ === Array.prototype  // true
    // 所以 [].filter === Array.prototype.filter
    concat = emptyArray.concat,  // 合并两个或者多个数组，返回一个新数组，不会改变现有数组，即浅拷贝
    filter = emptyArray.filter,  // 返回一个 经回调函数测试通过的所有元素的 新数组，
